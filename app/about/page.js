          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                At Medora, we believe that quality healthcare should be
                accessible to everyone, everywhere. Our mission is to bridge the
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                To democratize healthcare by providing instant access to medical
                professionals, comprehensive health education, and real-time
                health information through cutting-edge technology. We strive to
                make quality healthcare accessible, affordable, and available to
                everyone, regardless of their location or circumstances.
              </p>
            </div>
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                To create a world where healthcare barriers no longer exist,
                where every person has immediate access to medical expertise,
                and where technology empowers both patients and healthcare
                providers to achieve better health outcomes together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              The principles that guide everything we do at Medora
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-emerald-100">
              Making a difference in healthcare accessibility worldwide
            </p>
          </div>
